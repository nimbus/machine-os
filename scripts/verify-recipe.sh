...
grep -F 'quay.io/fedora/fedora-bootc@sha256:3ca807c0d2836ca425031a52dfe7fda69ca55a22c54fa78c068a22f43d6489b6' "${recipe_dir}/Containerfile" >/dev/null
...
grep -F -- 'quay.io/fedora/fedora-bootc@sha256:3ca807c0d2836ca425031a52dfe7fda69ca55a22c54fa78c068a22f43d6489b6' "${temp_dir}/podman.log" >/dev/null
...
grep -F 'fedora_bootc_base_image=quay.io/fedora/fedora-bootc@sha256:3ca807c0d2836ca425031a52dfe7fda69ca55a22c54fa78c068a22f43d6489b6' "${output_dir}/summary.txt" >/dev/null
...
grep -F 'sha256:3ca807c0d2836ca425031a52dfe7fda69ca55a22c54fa78c068a22f43d6489b6' "${output_dir}/nimbus-machine-os.sbom.cdx.json" >/dev/null
